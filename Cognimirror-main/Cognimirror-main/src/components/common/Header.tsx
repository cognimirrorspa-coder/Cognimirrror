    ...
    <header className={headerBgClass}>
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between py-4">
          ...
          >
            <img src="/logo.png" alt="CogniMirror Logo" className="h-14 w-auto drop-shadow-[0_0_8px_rgba(255,255,255,0.3)] transition-transform hover:scale-110" />
            <h1 className="text-3xl font-black bg-[linear-gradient(90deg,#9333ea_0%,#3b82f6_25%,#9333ea_50%,#3b82f6_75%,#9333ea_100%)] bg-[length:200%_auto] bg-clip-text text-transparent animate-aurora tracking-tight">CogniMirror</h1>
          </div>
