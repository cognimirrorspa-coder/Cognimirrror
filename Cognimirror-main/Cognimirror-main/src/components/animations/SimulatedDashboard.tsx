...
export const SimulatedDashboard = () => {
  ...
  useEffect(() => {
    // Optimization: Only update state if visible could be added, but for now we keep it as is
    // since this is just a setInterval updating light state, it's not the main FPS killer.
